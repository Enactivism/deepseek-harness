...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * Additive right workspace inside the center workbench. Its entries
     * participate in flex layout beside the conversation rather than floating
     * above it. This is the home for an optional companion or other persistent
     * workspace surface; it does not replace the tool-owned `details` column.
     */
    'shell.right': { kind: 'list'; scope: 'root' }
    /**
